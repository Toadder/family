  ...
  function ymapInit() {
    ...
    ymaps.ready(function () {
      let map = new ymaps.Map("ymap", {
        center: [55.89500094540503, 37.58784608936892],
        zoom: 18,
      ...
      let placemark = new ymaps.Placemark(
        [55.89503158178547, 37.58860101835052],
        {
          // Hint
          hintContent: "Здоровая Семья",
        },
        {
          preset: "islands#icon",
          iconColor: "#BF271F",
      ...
      function onResizeMap() {
        if (window.innerWidth < "767") {
          //Set New center
          map.setCenter([55.89503158178547, 37.58860101835052]);
        }  else {
          map.setCenter([55.89500094540503, 37.58784608936892]);
        }
      }
      onResizeMap();
...
$(document).ready(function () {
  ...
  (function () {
    const burgerOpen = $(".mobile-header__burger");
    const burgerClose = $(".header-menu__close");
  ...
  (function () {
    $(".info__spoiler").on("click", function (e) {
      $(this).toggleClass("_active").next().slideToggle(700);
      if ($(this).hasClass("_active")) {
        $(this).html('СКРЫТЬ МЕНЮ <span class="_icon-arrow-down"></span>');
      } else {
        $(this).html('РАСКРЫТЬ МЕНЮ <span class="_icon-arrow-down"></span>');
      }
    });
  })();

  (function () {
    $(".content-analysis__tab").on("click", function (e) {
      $(".content-analysis__tab").removeClass("_active");
      $(".content-analysis__description").removeClass("_active");

      $(this).addClass("_active");
      $(".content-analysis__description")
        .eq($(this).index())
        .addClass("_active");
    });
  })();
  ...
  (function () {
    if (sessionStorage.getItem("blankBool")) {
      $(".blank").addClass("_active");
      $(".footer").css("margin-bottom", $(".blank").outerHeight() + "px");
    }
    $(".card-info__btn").on("click", function (e) {
      if (!$(".blank").hasClass("_active")) {
        sessionStorage.setItem("blankBool", true);
        $(".blank").addClass("_active");
        $(".footer").css("margin-bottom", $(".blank").outerHeight() + "px");
      }
    });
  ...
  (function () {
    ...
    async function formSend(e) {
      ...
      if (error === 0) {
        $(".blank").removeClass("_active");
        $(".footer").css("margin-bottom", "0px");
        sessionStorage.removeItem("blankBool");
      }
    }
